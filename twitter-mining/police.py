...
class MyListener(StreamListener):
    ...
    # This is a "callback".  A callback is called
    # when an event it's subscribed to occurs.   
    def on_data(self, data):
        try:
            ...
            if (n % 100 == 0):
                ...
                file_name = 'twitter_police' + stamp + '.json'
...
'#BrownLivesMatter', '#BlueLivesMatter', '#HandsUpDontShoot', '#SayHerName', 
'#sayhisname', '#ICantBreathe', '#ICantBreath', '#Policebrutality', 
'#knowjusticeknowpeace', '#thinblueline', '#whosestreets', '#Stockleyverdict']
mentions_list = ['@BlueLivesMatter', '@ShaunKing', '@jstines3']
from_list = ['from:@BlueLivesMatter', 'from:@ShaunKing', 'from:@jstines3']
to_list = ['to:@BlueLivesMatter', 'to:@ShaunKing', 'to:@jstines3']
my_list = []
